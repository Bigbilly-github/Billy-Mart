                    ...
                    <div className="flex gap-[10px] mt-[10px] mb-[10px] items-center">
                     ...
                     <p className="font-normal text-[14px] pb-[20px] border-b border-slate-500">
                      ...
                      <div className="flex  gap-[15px] mt-[30px]">
                            ...
                            <button onClick={()=>addToCart(cart,product.id,product.price,cartitemdeliverychoice,cartitemquantity,setCart)} className="cursor-pointer text-[12px] sm:text-[16px]   md:text-[18px] sm:px-[20px] px-[8px] hover:bg-white hover:text-[red]  active:outline-2 active:outline-[red] duration-150 py-[10px] bg-[red] font-medium rounded-[5px] text-white"> Add to Cart</button>
