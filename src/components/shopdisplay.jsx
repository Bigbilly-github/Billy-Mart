...
function ShopDisplay (){
    ...
    return(
        <>
        <section className="w-full h-auto pb-[50px] flex justify-center mt-[50px]">
            <ShopSidebar/>
            
            <div className="lg:w-[70%] sm:w-[60%]  h-auto  gap-[20px] grid xl:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-y-[40px]  pt-[30px] px-[20px]">
