            ...
            <div className="w-[90%] flex gap-[50px] items-center">
                ...
                <div className="flex-1  ">
                    <form action="" className="w-[100%] flex flex-col  ">
                        ...
                        <div>
                              <textarea name="message" id="message" className="block w-full mb-[50px] h-[200px] outline-0 p-[15px] flex-1 rounded-[5px] bg-slate-100" placeholder="Your message" ></textarea>
